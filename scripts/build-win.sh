...
SDL_PREFIX_PATH="${WIN_SDL_ROOT}/SDL2-2.30.9/x86_64-w64-mingw32;${WIN_SDL_ROOT}/SDL2_image-2.8.2/x86_64-w64-mingw32;${WIN_SDL_ROOT}/SDL2_ttf-2.22.0/x86_64-w64-mingw32"
