...
private:
    ...
    int spawnerSpiresDestroyed_{0};
    int escortsTransported_{0};
    int spawnerEventsCompleted_{0};
    int bountyEventsCompleted_{0};
    int pickupsCollected_{0};
    int itemsCollected_{0};
    int powerupsCollected_{0};
    int revivesCollected_{0};
    int revivesUsed_{0};
    int64_t copperPickedUp_{0};
    int64_t goldPickedUp_{0};
    ...
    int64_t totalBossesKilled_{0};
    int64_t totalBountyTargetsKilled_{0};
    int64_t totalPickupsCollected_{0};
    int64_t totalItemsCollected_{0};
    int64_t totalPowerupsCollected_{0};
    int64_t totalRevivesCollected_{0};
    int64_t totalRevivesUsed_{0};
    int64_t totalCopperPickedUp_{0};
    int64_t totalGoldPickedUp_{0};
    int64_t totalEscortsTransported_{0};
    int64_t totalAssassinsThwarted_{0};
    int64_t totalBountyEventsCompleted_{0};
    int64_t totalSpawnerEventsCompleted_{0};
    int64_t totalSecondsPlayed_{0};
    float statsScroll_{0.0f};
    // Multiplayer state
